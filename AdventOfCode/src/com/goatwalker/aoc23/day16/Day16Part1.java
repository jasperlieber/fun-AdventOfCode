...
public class Day16Part1 {
  ...
  public static void main(String[] args) throws Exception {
    Day16Part1 puzzle = new Day16Part1();
    puzzle.doit();
  }
   ...
   * @throws Exception
   */
  private void rayTrace() throws Exception {

    // add the initial ray to the search list
    D16Ray ray = new D16Ray(-1, 0, D16Dir.east);
    bfsList.add(ray);
...
//    scanner.close();
    ...
    System.out.println("energized = " + d16grid.getEnergizedCnt());
